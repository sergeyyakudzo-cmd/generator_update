const CACHE_NAME = 'generator-v1.1.3';

// Ресурсы для кэширования при установке
const STATIC_ASSETS = [
  '/generator_new.html',
  '/styles.css',
  '/js/01-audio.js?v=1.1.4',
  '/js/02-formatters-calendar.js?v=1.1.4',
  '/js/03-data-state.js?v=1.1.4',
  '/js/04-ui-form.js?v=1.1.4',
  '/js/05-telegram-zimbra.js?v=1.1.4',
  '/js/06-notification-generators.js?v=1.1.4',
  '/js/07-init-queue-pwa.js?v=1.1.4',
  '/manifest.json',
  '/config.json',
  '/icons/icon-192.png',
  '/icons/icon-512.png'
