    ...
    while ($listener.IsListening) {
        try {
            ...
            if (Test-Path $filePath) {
                ...
                elseif ($filePath.EndsWith(".png")) { $contentType = "image/png"; $isBinary = $true }
                elseif ($filePath.EndsWith(".jpg") -or $filePath.EndsWith(".jpeg")) { $contentType = "image/jpeg"; $isBinary = $true }
                elseif ($filePath.EndsWith(".svg")) { $contentType = "image/svg+xml" }
                elseif ($filePath.EndsWith(".ico")) { $contentType = "image/x-icon"; $isBinary = $true }
                if ($isBinary) {
