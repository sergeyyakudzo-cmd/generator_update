...
$Response = Invoke-RestMethod -Uri "https://api.github.com/repos/$Repo/releases/latest" -Headers $Headers -TimeoutSec 30 -Proxy "" -ProxyUseDefaultCredentials
...
$Web.Proxy = [System.Net.WebRequest]::GetSystemWebProxy()
